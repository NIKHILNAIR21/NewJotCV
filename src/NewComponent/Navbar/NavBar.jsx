      ...
      <div className="">
        <div className="main  hidden md:flex justify-evenly relative z-50  w-full bg-white  rounded-xl  ">
          <div className="flex items-center justify-between p-0.5 xl:px-32  lg:w-full ">
            ...
            <div
              className="cursor-pointer flex gap-2 p-2 md:px-10 lg:px-5 items-center font-poppins  text-xs md:text-sm lg:text-lg text-sky-500 font-semibold border-2 border-sky-500
