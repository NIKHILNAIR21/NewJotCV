...
const Skillinfo = () => {
  ...
  //       dispatch(addSkill({ name: item?.skill, type: item?.type }));
  //     });
  //   }
  // }, []);
    ...
    <div>
      ...
      >
        {({ values, setFieldValue }) => (
          <Form>
            <div className="overflow-y-auto p-6  rounded-b-2xl bg-white h-full no-scrollbar">
              <Field
                type="text"
                name="name"
                value={values?.name}
                ...
                className="block appearance-none w-[39rem]  sm:w-[36rem] md:w-[30rem] bg-white border rounded-md border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 "
              />
