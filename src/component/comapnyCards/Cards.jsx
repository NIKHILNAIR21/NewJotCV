  ...
  return (
    <>
      <div
        ...
        key={id}
        className="bg-white cursor-pointer hover:shadow-blue-400 flex justify-between items-center rounded-md shadow-xl w-full sm:w-[46%] md:w-[33%] lg:w-[30%] h-[90%]  md:h-32 p-3"
      >
