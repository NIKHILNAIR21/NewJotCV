...
const Faq = () => {
  ...
  return (
    <>
      <h1 className="text-2xl md:text-[36px] py-10 text-center font-medium">
      ...
      <div className="flex  flex-col sm:flex-row justify-center w-[70%] mx-auto gap-2 sm:gap-20">
        ...
        <div className="sm:w-[50%] flex flex-col gap-2">
          ...
          <div className="flex items-center">
            ...
            <img onClick={() => handleOpen(4)} className="w-6 h-6 cursor-pointer" src={dropdown} alt="dropdown" />
          </div>
            <AccordionBody className="pt-0 text-base font-normal">
          ...
          <div className="flex items-center">
            ...
            <img onClick={() => handleOpen(5)} className="w-6 h-6 cursor-pointer" src={dropdown} alt="dropdown" />
          </div>
            <AccordionBody className="pt-0 text-base font-normal">
          ...
          ><div className="flex items-center">
            ...
            <img onClick={() => handleOpen(6)} className="w-6 h-6 cursor-pointer" src={dropdown} alt="dropdown" />
          </div>
            <AccordionBody className="pt-0 text-base font-normal">
