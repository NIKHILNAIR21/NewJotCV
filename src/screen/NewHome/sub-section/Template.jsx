    ...
    return AVAILABLE_TEMPLATES.map((item, index) => (
      ...
      >
        ...
        <button
          ...
          className="bg-[#1583FF] text-white absolute font-poppins rounded-l-full text-[20px] rounded-r-full  bottom-12 py-2.5 px-8 transition-all delay-20 border-4 border-blue-100  left-0 right-0 w-fit mx-auto font-medium"
        >
          Preview
        </button>
      </div>
        ...
        <>
          <div className=" justify-center items-center flex fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-full my-5 mx-auto  ">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[95%] sm:w-[80%] md:w-[33%] h-full  mx-auto  bg-white outline-none focus:outline-none">
...
border-black text-white bg-sky-500  p-1 px-2 rounded-full"
                ...
                {/*body*/}
                <div className=" h-[35rem] bg-sky-300 overflow-auto ">
                  <img
                    src={showImg}
                    alt="Single Image"
