    ...
    <>
      <div>
        <div className="main ">
          ...
          <div className="flex flex-wrap justify-center mb-10 items-center gap-10">
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp1} alt="" />
              <p className="text-center text-lg">
                Modern{" "}
                <div className="flex justify-between">
                  <span
                    className="relative flex  justify-end items-center border-2 rounded-r-full rounded-l-full w-fit text-black  mx-2  px-2  cursor-pointer text-lg capitalize"
                    onClick={() => {
                  ...
                  >
                    <br />
                    <p className="text-sm font-semibold px-1.5">Preview</p>
                  </span>
                  ...
                  {subs !== null ? (
                    ...
                    >
                      <br />
                      <p className="text-sm font-semibold px-1.5">Set Url</p>
                    </span>
                  ):(
                    <span
                      className="relative flex  justify-end items-center border-2 rounded-r-full rounded-l-full w-fit text-black  mx-2  px-2  cursor-pointer text-lg capitalize"
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp2} alt="" />
              <p className="text-center text-lg">
                Basic
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp3} alt="" />
              <p className="text-center text-lg">
                Developer
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp4} alt="" />
              <p className="text-center text-lg">
                Classic
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp7} alt="" />
              <p className="text-center text-lg">
                Excellent
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp8} alt="" />
              <p className="text-center text-lg">
                New Modern
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp9} alt="" />
              <p className="text-center text-lg">
                Creative
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp11} alt="" />
              <p className="text-center text-lg">
                Myport
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp12} alt="" />
              <p className="text-center text-lg">
                steller
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp10} alt="" />
              <p className="text-center text-lg">
                Proman
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp13} alt="" />
              <p className="text-center text-lg">
                DevModern
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp14} alt="" />
              <p className="text-center text-lg">
                DevFolio
                <div className="flex justify-between">
                  <span
            ...
            <div className="p-3 shadow-xl rounded-lg bg-sky-200">
              <img className="w-[31rem] h-72 rounded-md" src={temp15} alt="" />
              <p className="text-center text-lg">
                Kards
                <div className="flex justify-between">
                  <span
