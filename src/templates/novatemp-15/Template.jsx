    ...
    <div>
      <div className="main-container  p-2.5 bg-white ">
        <header>
          ...
          <div>
            <p className="text-white text-sm bg-pink-900 p-2 rounded-md">
              {resumeData?.summary}
            </p>
          </div>
          {/* contact */}
        ...
        <div className="flex  gap-4">
          <div className="left w-[50%]">
            ...
            <div className=" p-1">
              ...
              <span className="bg-pink-900 w-96 h-[2.3px]  block" />
              {/* exp */}
          ...
          <div className="right w-[50%] ">
            ...
            <div className="">
              ...
              {resumeData?.skills?.map((item) => {
                <p className="text-sm bg-pink-900 text-white rounded p-1">
                  {item?.skill}
                </p>
              })}
            ...
            <div className="mt-2">
              ...
              {resumeData?.interests?.map((item) => (
                <p className="text-sm font-semibold text-pink-900">{item?.interest}</p>
              ))}
              </div>
            </div>
            {/* Languages */}
            <div className="mt-2">
              ...
              {resumeData?.languages?.map((item) => (
               <p className="text-sm text-pink-900 font-semibold">{item?.language}</p>
              ))}
              </div>
            </div>
            {/* certificates */}
