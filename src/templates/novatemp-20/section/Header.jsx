  ...
  return (
    <div className="px-2">
      <header className="flex relative flex-col justify-start text-center   gap-x-6 items-center">
        ...
        <div className="border-r-2 border-l-2 p-1 mt-6 border-emerald-800 border-b-2 border-t-2 rounded-xl"  >
          <h3 className="font-medium text-emerald-800 capitalize text-base">{profession}</h3>
