        ...
        <div className="px-2">
          <header className="flex justify-start gap-x-6 items-start">
            ...
            <div>
              ...
              <p className="font-medium bg-gray-200 p-0.5 rounded-lg text-sm">
                {resumeData?.summary}
              </p>
            </div>
          </header>
          ...
          <section className="flex justify-between">
                  ...
                  <div>
                    {resumeData?.projects?.map((project) => (
                      <div className="mt-1 p-1 text-justify">
                        ...
                        <div className="flex gap-2">
                          <a href=  {project?.link} className="text-sm text-black">
                          Project Link
                          </a>
            ...
            <div className="w-[50%]">
              <div className=" flex flex-col">
                <div className="bg-gray-200 rounded-md w-fit p-1">
                  <h1 className="font-semibold uppercase text-base mt-1 ">
                    Skills
                  </h1>
                ...
                {/* languages */}
                <div className="p-1 bg-gray-200 rounded-md w-fit mt-2.5">
                  <h1 className="font-semibold uppercase text-base mt-1 ">
                    Language
                  </h1>
                ...
                {/*  certificates*/}
                <div className="w-fit bg-gray-200 rounded-md p-1 mt-1">
                ...
                {/* Interest*/}
                <div className="w-fit bg-gray-200 rounded-md p-1 mt-2.5">
